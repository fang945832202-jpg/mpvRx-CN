...
<p align="center">
  <b>MpvRx 中文本地化版本</b>
  <br>
  <i>基于 libmpv 的功能丰富、高效强大的 Android 视频播放器</i>
</p>
...
此项目是基于 **[Riteshp2001/mpvRx](https://github.com/Riteshp2001/mpvRx)** 汉化而来的中文本地化版本。

> 原项目 MpvRx 由 [Riteshp2001](https://github.com/Riteshp2001) 开发，是一个基于 libmpv 的 Android 视频播放器，功能极其丰富，被誉为"互联网上功能最齐全的视频播放器之一"。
...
汉化完成后，本项目将提供完全中文化的用户界面，让中文用户能够更加方便地使用这款优秀的视频播放器。

---

## 🙏 致谢

感谢原项目作者 [Riteshp2001](https://github.com/Riteshp2001) 开发了如此出色的视频播放器！

原项目地址：[https://github.com/Riteshp2001/mpvRx](https://github.com/Riteshp2001/mpvRx)
